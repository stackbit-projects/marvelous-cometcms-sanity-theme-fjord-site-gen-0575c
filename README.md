...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/6020575c1cef9100162811d4
...
To start editing your site, you can use the Sanity interface at https://marvelous-cometcms-sanity-theme-fjord-site-gen-0575c.sanity.studio/.
...
Generated at `2021-02-07T21:11:01.964Z` by Stackbit version `0.3.48`.